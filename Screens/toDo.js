...
export default function TODO ({ navigation }) {
  ...
  const onChange = (event, selectedDate) => {
    ...
    const tempDate = Date(currentDate)
    const fDate =
      tempDate.getDate() +
      '-' +
      (tempDate.getMonth() + 1) +
      ...
      >
        ...
        <View style={styles.addLocationModal}>
          <View style={styles.addTaskLocationSearchBtn}>
            ...
            <TouchableOpacity style={styles.addTaskLocationSearchBtn}>
              <Image
                source={{ uri: 'https://' }}
                style={styles.addTaskLocationSearchIcon}
              />
            </TouchableOpacity>
          </View>
        </View>
